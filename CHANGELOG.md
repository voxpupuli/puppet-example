...
## [v0.14.0](https://github.com/voxpupuli/puppet-example/tree/v0.14.0) (2026-03-26)

[Full Changelog](https://github.com/voxpupuli/puppet-example/compare/v0.13.3...v0.14.0)

**Merged pull requests:**

- adjust branch pattern [\#171](https://github.com/voxpupuli/puppet-example/pull/171) ([bastelfreak](https://github.com/bastelfreak))

## [v0.13.3](https://github.com/voxpupuli/puppet-example/tree/v0.13.3) (2026-03-26)

[Full Changelog](https://github.com/voxpupuli/puppet-example/compare/v0.13.2...v0.13.3)

**Merged pull requests:**

- fix typos in workflows [\#169](https://github.com/voxpupuli/puppet-example/pull/169) ([bastelfreak](https://github.com/bastelfreak))

## [v0.13.2](https://github.com/voxpupuli/puppet-example/tree/v0.13.2) (2026-03-26)

[Full Changelog](https://github.com/voxpupuli/puppet-example/compare/v0.13.1...v0.13.2)

**Merged pull requests:**

- fix typos in workflows [\#167](https://github.com/voxpupuli/puppet-example/pull/167) ([bastelfreak](https://github.com/bastelfreak))
- release CI; fix typo [\#166](https://github.com/voxpupuli/puppet-example/pull/166) ([bastelfreak](https://github.com/bastelfreak))
- release workflow: set deployment [\#164](https://github.com/voxpupuli/puppet-example/pull/164) ([bastelfreak](https://github.com/bastelfreak))

## [v0.13.1](https://github.com/voxpupuli/puppet-example/tree/v0.13.1) (2026-03-26)

[Full Changelog](https://github.com/voxpupuli/puppet-example/compare/v0.13.0...v0.13.1)

**Fixed bugs:**

- create tag: use fewer github perms [\#163](https://github.com/voxpupuli/puppet-example/pull/163) ([bastelfreak](https://github.com/bastelfreak))
...
- Release 0.12.0 [\#157](https://github.com/voxpupuli/puppet-example/pull/157) ([pccibot](https://github.com/pccibot))
